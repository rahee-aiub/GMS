<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A2ZERP.aspx.cs" Inherits="ATOZWEBGMS.Pages.A2ZERP" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="DivMain" runat="server">
            ...
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnCustomerService" runat="server" Text="Accounts Service" class="btnAcc"                           
   ...
   <div align="center">
       ...
       <table>
           <tr>
               <td>
                    Developed By AtoZ Computer Services - Cloud Version 2.00
               </td>
           </tr>
           <tr>
               <td>
