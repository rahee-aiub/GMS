...
namespace ATOZWEBGMS.Pages
{
    public partial class AccountStatement : System.Web.UI.Page
    {
        ...
        protected void FunctionName()
        {
            ...
            lblStatementFunc.Text = "Account Statement";
        ...
        protected void BtnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Account No. Not Selected');", true);
                    return;
                }
        ...
        private void FindAccountNo()
        {
            ...
            if (ChkAccStatus.Checked == true)
            {
                qry = "SELECT AccType,AccNo FROM A2ZACCOUNT WHERE AccPartyNo='" + txtPartyCode.Text + "' AND AccType='" + txtAccType.Text + "' AND AccStatus < 98";
            }
            else
            {
                qry = "SELECT AccType,AccNo FROM A2ZACCOUNT WHERE AccPartyNo='" + txtPartyCode.Text + "' AND AccType='" + txtAccType.Text + "' AND AccStatus = 99";
            }
